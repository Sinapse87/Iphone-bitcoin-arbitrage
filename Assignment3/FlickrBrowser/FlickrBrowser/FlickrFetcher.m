...
{
    NSString *apiString = @"http://api.flickr.com/services/rest/?method=flickr.photos.search";
    NSString *query = [NSString stringWithFormat:@"%@&per_page=500&license=1,2,4,7&has_geo=1&extras=original_format,tags,description,geo,date_upload,owner_name,place_url", apiString];
    return [FlickrFetcher URLForQuery:query];
}
